...
class Vertex {
	...
	protected int key;															//deklaruje promenou pro identifikaci vrcholu obdoba Id u objektu
	protected char color;														//deklaruje promenou pro algoritmy heldani nejkratsich cest
	protected int predecessor;													//deklaruje promenou pro uchovani poctu predchucu vrcholu
...
class Graph {
	...
	private Vertex[] vertexes;													//deklaruje pole s vrcholy	
	private int[][] adjMatrix;													//deklaruje matici sousednosti
	private int vertexCount;													//deklaruje promenou s konecnym poctem vrcholu
	private int vertexCreated = 0;												//deklaruje promenou s poctem vytvorenych vrcholu
	private boolean connected;													//deklaruje promenou uchovavajici typ grafu		
